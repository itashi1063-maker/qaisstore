// مصفوفة البيانات المحدثة بجميع تطبيقاتك
const myApps = [
    {
        name: "Blood Wars",
        version: "v1.0",
        icon: "⚔️", // أيقونة السيوف لتناسب اسم اللعبة
        url: "https://drive.google.com/file/d/1P19N2VBxWDvSxoWYI5uOrQzOoe0V6Ehw/view"
    },
    {
        name: "Brawl QR Gift",
        version: "Latest",
...
function loadApps(filter = "") {
    ...
    if (filtered.length === 0) {
        container.innerHTML = "<p style='grid-column: 1/-1; text-align: center; color: #888;'>لا توجد نتائج مطابقة لبحثك.</p>";
    }
}
